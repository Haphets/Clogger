 ...
 * ON 17/11/30
 */
public class CloggerMultithreadTest {
    private static Clogger flogger = Clogger.getInstance();
    ...
    private static int threadNum = 2;  //1,2,4,8,16,32
